			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						...
						<td>
							<label><input type="radio" name="calslider" value="left" class="option" checked="checked" /> <?php echo esc_html( __( 'left', 'range-slider-field-for-contact-form-7' ) ); ?></label>
							<label><input type="radio" name="calslider" value="right" class="option" /> <?php echo esc_html( __( 'right', 'range-slider-field-for-contact-form-7' ) ); ?></label>
						</td>
					</tr>
					<tr>
						<th scope="row">
					...
					<tr>
						...
						<td>
							<label><input type="radio" name="slidershow" value="single" class="option" checked="checked" /> <?php echo esc_html( __( 'Single Edge', 'range-slider-field-for-contact-form-7' ) ); ?></label>
							<label><input type="radio" name="slidershow" value="double" class="option" /> <?php echo esc_html( __( 'Double Edge', 'range-slider-field-for-contact-form-7' ) ); ?></label>
						</td>
					</tr>
					<tr>
						<th scope="row">
